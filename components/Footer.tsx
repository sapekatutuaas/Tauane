  ...
  return (
    <footer id="contato" className="bg-brand-navy text-white pt-20 pb-10">
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-12 gap-12 border-t border-white/10 pt-16">
        ...
        <div className="lg:col-span-4">
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a href={CONTACT_INFO.whatsappLink} className="flex items-center gap-3 text-gray-400 hover:text-brand-gold transition-colors">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#20bd5a] transition-transform hover:scale-110 flex items-center justify-center animate-bounce-slow"
